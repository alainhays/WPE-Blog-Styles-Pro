<?php
/* ### This is the Helpers behind the Header and Footer Unlimited Engine ### */
if(!class_exists('WPE_php_helpers')){ /* check if already exists */

class WPE_php_helpers {
    ...
    public static function remove_from_array_by_name ($array, $name, $value )
    {
    ...
    public static function grab_data_inside_tag($data, $start_tag, $end_tag){
    ...
    public static function filter_out_everything_between_these_tags($beginning, $end, $string) {
        $finalString = $string;
    ...
    public static function unique_name_in_dir($dir, $filename, $particle){
...
global $WPE_helpers;
$WPE_helpers = new WPE_php_helpers; 
